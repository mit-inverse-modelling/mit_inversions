...
class InversionSetupRun:
    ...
    def run(self):
        ...
        for i, site in enumerate(self.sites):
            ...
            y_err = (self.fp_sens_dict_out[site]['mf_variability'].values ** 2 + self.fp_sens_dict_out[site]['mf_repeatability'].values ** 2 + self.fp_sens_dict_out[site]['mf_model_error'].values ** 2)
